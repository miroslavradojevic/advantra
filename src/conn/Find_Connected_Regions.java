package conn;/* -*- mode: java; c-basic-offset: 8; indent-tabs-mode: t; tab-width: 8 -*- */
...
//    Button cancel;
//    conn.Find_Connected_Regions plugin;
//    public CancelDialog(conn.Find_Connected_Regions plugin) {
