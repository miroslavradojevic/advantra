...
/**
 * Created by miroslav on 6/12/14.
 */
public class ClusterDirections {
	...
	private static float[][]	meanShift(ArrayList<float[]> v, int max_iter, float epsilon, float alfa) // v are directions, should be normalized
	{
