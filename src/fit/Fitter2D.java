...
/**
 * Created by miroslav on 6/22/14.
 */
public class Fitter2D {
	...
	public Fitter2D(int _radial_len, int _tangen_len, float _cross_sigma_ratio, boolean verbose) // _tangen_len has to be 2N+1 length
	{
