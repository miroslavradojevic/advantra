...
load(file="~/projects/ndethcmml/01_data/hog_4_1_mosaic_1_8.RData")

tasks =   makeClassifTask(id = "hog_4_1_mosaic_1_8", data = hog_4_1_mosaic_1_8, target = "class")
...
bmr.hog_4_1_mosaic_1_8.cforest = benchmark(lrns, tasks, outer, measures = list(acc, auc,tpr,fpr), show.info = F,models = F)