...
load(file="~/projects/ndethcmml/01_data/hog_8_1_mosaic_1_8.RData")

tasks =   makeClassifTask(id = "hog_8_1_mosaic_1_8", data = hog_8_1_mosaic_1_8, target = "class")
...
ps = makeParamSet(
  ...
  makeDiscreteParam("mtry", values=seq(5,36,by=3)))
...
bmr.hog_8_1_mosaic_1_8.cforest.rforest = benchmark(lrns, tasks, outer, measures = list(acc, auc,tpr,fpr), show.info = T,models = F)