...
load(file="~/projects/ndethcmml/01_data/scspm_200_mosaic_1_8.RData")

tasks =   makeClassifTask(id = "scspm_200_mosaic_1_8", data = scspm_200_mosaic_1_8, target = "class")
...
bmr.scspm_200_mosaic_1_8.cforest.rforest = benchmark(lrns, tasks, outer, measures = list(acc, auc,tpr,fpr), show.info = T,models = F)
