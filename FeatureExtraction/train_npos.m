function train_npos(D, S, OPOS, NW, NPOS)
% clc;
% clear all;
% close all;
%--------------------------------------
...
%--------------------------------------
% the sample will have (number of neurons annoted * NOPOS) positive patches. careful, it's possible that the set won't be balanced.
%--------------------------------------
